...
INSERT INTO pachete (id_producator, nume, imagine, pret_total, pret_abonament, descriere, e_abonament, frecventa_livrare) VALUES
  (12, 'Pachet Fructe 1', '/uploads/pachete/12/pachet_mere.jpg', 11.0, 9.0, 'Pachet cu fructe de sezon - Reducere 18% la abonament!', true, 7),
  (13, 'Pachet Fructe 2', '/uploads/pachete/13/pachet_rosii.jpg', 12.0, NULL, 'Mix de fructe exotice', false, null),
  (14, 'Pachet Legume', '/uploads/pachete/14/pachet_castraveti.jpg', 13.5, 12.0, 'Legume proaspete pentru salată', true, 14),
  (15, 'Pachet Lactate', '/uploads/pachete/15/pachet_branza.jpg', 6.0, 5.0, 'Brânzeturi și lapte bio - Super preț la abonament!', true, 30),
  (16, 'Pachet Mixt 1', '/uploads/pachete/16/pachet_lapte.jpg', 10.0, NULL, 'Combinație fructe și legume', false, null),
  (17, 'Pachet Mixt 2', '/uploads/pachete/17/pachet_paine.jpg', 4.0, 3.5, 'Pachet mare pentru familie', true, 7),
  (18, 'Pachet Panificatie', '/uploads/pachete/18/pachet_ulei.jpg', 30.0, 25.0, 'Pâine și produse de patiserie', true, 7),
  (19, 'Pachet Bauturi', '/uploads/pachete/19/pachet_cafea.jpg', 16.0, NULL, 'Sucuri naturale și siropuri', false, null),
  (20, 'Pachet Alimentar', '/uploads/pachete/20/pachet_zahar.jpg', 27.5, 25.0, 'Produse de bază (ulei, zahăr, făină)', true, 30),
  (12, 'Pachet Premium', '/uploads/pachete/12/pachet_mere_pere.jpg', 27.5, 23.0, 'Selecție gourmet', true, 14);
-- ========================================================
