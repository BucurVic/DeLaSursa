...
interface ClientOrderViewProductCardProps {
  productId: number;
  image: string;
  title: string;
  category: string;
...
const ClientOrderViewProductCard: React.FC<ClientOrderViewProductCardProps> = ({
  productId,
  image,
  title,
  category,
...
export default ClientOrderViewProductCard;
