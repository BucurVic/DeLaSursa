export const textResources = {
  ...
  dashboardUrls: {
    dashboard: "/dashboard-producator",
    products: "/dashboard-producator/produse",
    orders: "/dashboard-producator/comenzi-primite",
    stats: "/dashboard-producator",
    reviews: "/dashboard-producator",
    messages: "/dashboard-producator",
    bundles: "/dashboard-producator/pachete",
    subscriptions: "/dashboard-producator/abonamente",
  ...
  hero: {
    ...
    subtitle:
      "Descoperă cele mai bune produse locale de la producători verificați. Sustennabilitate, calitate și prospețime în fiecare comandă.",
  ...
  products: {
    addText: {
      ...
      discoverProducts:
        "Descoperă produse autentice de la producători verificați",
    },
    filters: {
      category: "Categorie",
      region: "Regiune",
  ...
  producerDashboard: {
    ...
    mostLikedProducts: "Produsele favorite ale clienților",
    salePlot: "Vânzări în ultimele 30 de zile",
    lowInventory: "Produse cu stoc scăzut",
  },
  ...
  adminUsers: {
    ...
    messages: {
      deleteConfirmDynamic:
        "Ești sigur că vrei să ștergi contul utilizatorului {name}? Această acțiune este ireversibilă.",
  ...
  checkout: {
    ...
    paymentModal: {
      ...
      message:
        "Ești pe cale să plătești suma de {amount} RON. Confirmi tranzacția?",
      confirmButton: "Confirmă Plata",
    },
    button: "Plasează Comanda",
    successMessage:
      "Comanda a fost plasată cu succes! Vei primi un email de confirmare.",
  },
  deliveryMethods: {
