...
const mapBackendToFrontend = (pachet: PachetDTO): BundleDetailData => {
  ...
  return {
    ...
    images: pachet.imagine
      ? [pachet.imagine]
      : ["https://images.unsplash.com/photo-1542838132-92c53300491e?w=800"], // Use fetched image or default
...
const BundleDetailsPage = () => {
  ...
  if (loading)
    return <Typography sx={{ p: 4 }}>{textResources.loadingText}</Typography>;
  if (!bundle)
    return (
      <Box
        sx={{
      ...
      >
        ...
        <Button
          onClick={() => navigate(-1)}
          sx={{ ml: 2, color: colors.lightGreen1 }}
        >
          Înapoi
        </Button>
      </Box>
      ...
      >
        ...
        >
          ...
          >
            ...
            <Typography
              component="span"
              sx={{ fontSize: "1rem", color: colors.white2, ml: 1 }}
            >
              / livrare
            </Typography>
          </Typography>
                ...
                <ListItem key={idx} disableGutters sx={{ py: 0.5 }}>
                  <ListItemIcon sx={{ minWidth: 32 }}>
                    <CheckCircleOutlineIcon
                      sx={{ color: colors.lightGreen1, fontSize: "1.2rem" }}
                    />
                  </ListItemIcon>
                  <ListItemText
                    primary={
          ...
          >
            ...
            <Button
              ...
              color="success"
              onClick={() => {
                console.log(`Abonare la pachet ${bundle.id}`);
              }}
              sx={{
                height: "3rem",
                borderRadius: "0.6rem",
