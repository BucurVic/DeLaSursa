...
const HomePage: React.FC = () => {
  ...
  const mockProducers = [
    {
      ...
      productCount: 24,
      description:
        "Fermă organică de familie cu tradiție de peste 30 de ani în cultivarea legumelor și fructelor.",
    },
    {
      producerId: "2",
      coverImage:
        "https://hillfarmrealfood.co.uk/cdn/shop/files/30_eggs_1.jpg?v=1749138750&width=1445",
      ...
      productCount: 15,
      description:
        "Ouă proaspete de la găini crescute liber în curte. Grijă și atenție pentru fiecare pasăre.",
    },
    {
      producerId: "3",
      coverImage:
        "https://t4.ftcdn.net/jpg/02/21/34/43/360_F_221344370_divU4PPEj49VhfthdlnAxA3rD3TAzuZT.jpg",
      ...
      productCount: 32,
      description:
        "Iaurt, brânză și lapte de la vaci crescute natural în zona Sibiului.",
    },
    {
      producerId: "4",
      coverImage:
        "https://media.istockphoto.com/id/178850019/photo/beekeeper-lifting-a-tray-out-of-a-beehive.jpg?s=612x612&w=0&k=20&c=Zjv053d2Iec5KxpOpITUBCAqvNcapvOYu13tykkcJ58=",
      ...
      productCount: 12,
      description:
        "Miere pură de munte din Bucegi. Stupine plasate pentru cea mai bună calitate.",
    },
    {
      producerId: "5",
      coverImage:
      ...
      productCount: 28,
      description:
        "Pâine artizanală făcută manual. Copt proaspăt în fiecare zi.",
    },
    {
      producerId: "6",
      coverImage:
        "https://www.camelactive.com/media/f5/a0/ce/1682402635/camel-active_blog-foodforest_09.jpg",
      ...
      productCount: 18,
      description:
        "Fructe de pădure și conserve artizanale din Maramureș. Produse naturale 100%.",
    },
  ];
  ...
  return (
    ...
    >
      ...
      <TopProducersSection producers={mockProducers} />
