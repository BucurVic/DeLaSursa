...
const AdminOverviewPage: React.FC = () => {
  ...
  const activities = [
    ...
    {
      text: "Produs 'Lapte Proaspăt' stoc epuizat",
      time: "Azi, 09:15",
      alert: true,
    },
    {
      text: "Utilizator 'Elena D.' a lăsat o recenzie nouă",
      time: "Ieri, 18:40",
    },
  ];
    ...
    <Box sx={{ color: colors.white1, pb: 4 }}>
      ...
      {loading ? (
        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
          ...
          >
            <Paper sx={cardStyle}>
              <Typography variant="body2" sx={{ color: colors.white2, mb: 1 }}>
                Utilizatori Totali
              </Typography>
              <Typography
                variant="h3"
                sx={{ color: colors.lightGreen1, fontWeight: "bold" }}
              >
                {stats?.totalUseri ?? "-"}
              </Typography>
              <Typography variant="caption" sx={{ color: colors.lightGreen2 }}>
                +12 săptămâna asta
              </Typography>
            </Paper>
                  ...
                  {recentOrders.map((order, index) => (
                    ...
                    >
                      <Box>
                        ...
                        <Typography
                          variant="caption"
                          sx={{ color: colors.white2, opacity: 0.7 }}
                        >
                  ...
                  {activities.map((act, index) => (
                    <Box
                      ...
                      sx={{
                        ...
                        pl: 3,
                        pb: 1,
                        borderLeft: `2px solid ${colors.lightGreen1Transparent}`,
                      }}
                    >
                      <Box
                        sx={{
                      ...
                      <Typography
                        variant="body2"
                        sx={{ color: colors.white1, lineHeight: 1.4, mb: 0.5 }}
                      >
                        {act.text}
                      </Typography>
                      <Typography
                        variant="caption"
                        sx={{ color: colors.white2, opacity: 0.6 }}
                      >
                        {act.time}
                      </Typography>
                    </Box>
